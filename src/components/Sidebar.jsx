        ...
        <Popover>
            ...
            <Transition.Root>
                ...
                >
                    <Popover.Panel
                        as="div"
                        className="absolute inset-x-0 top-full mt-4 flex origin-top flex-col rounded-2xl bg-white dark:bg-slate-700 dark:text-slate-100 p-4 text-lg tracking-tight text-slate-900 shadow-xl ring-1 ring-slate-900/5"
                    >
                        <MobileNavLink href="#">
...
export function Sidebar() {
    return (
        <>
            <nav className="flex flex-row justify-between items-center sticky w-full p-4 sm:hidden bg-zinc-100 dark:bg-zinc-700">
            ...
            <div className="flex flex-col p-8 top-0 bg-zinc-100 dark:bg-zinc-700 w-[250px] sticky h-screen justify-between max-sm:hidden">
                <nav className="">
                    <Link href="/" aria-label="Home" className=''>
                        <span className='text-blue-600 font-extrabold text-4xl'>Brent<span className='text-slate-700 dark:text-slate-100'>.S</span></span>
                    </Link>
